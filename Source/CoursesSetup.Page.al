    ...
    layout
    {
        area(content)
        {
            group(Numbering)
            {
                ...
                {
                    ApplicationArea = All;
                    ToolTip = 'Specifies the number series code you can use to assign numbers to Courses.', Comment = 'ESP="Especifica el código de serie numérica que se puede utilizatr para asignar números a los cursos"';
                }
            }
        }
        area(factboxes)
